...
export const SF_CFA_FORWARDER = "0xcfA132E353cB4E398080B9700609bb008eceB125" as const;
export const SF_SUPER_TOKEN_FACTORY = "0x36be86dEe6BC726Ed0Cbd170ccD2F21760BC73D9" as const;
// USDCx — canonical super token wrapper for USDC, deployed permissionlessly on first subscription
// Address is deterministic (CREATE2); queried on-chain via computeCanonicalERC20WrapperAddress
